...
def update_scan_parameters():
    """
    Exercise 10: Updating Dictionary Entries                                                              ###done
